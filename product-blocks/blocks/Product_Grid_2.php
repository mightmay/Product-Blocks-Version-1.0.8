        ...
        $attributes = array(
            ...
            'shortDescLimit' => [
                ...
                'style' => [
                    (object)[
                        'depends' => [
                            (object)['key'=>'showFullShortDesc','condition'=>'==','value'=>false],
                        ],
                    ],
                ],
            ],
            ...
            'cartBorder' => [
                'type' => 'object',
                'default' => (object)['openBorder'=>0, 'width' => (object)['top' => 1, 'right' => 1, 'bottom' => 1, 'left' => 1],'color' => '#FF4747','type' => 'solid'],
                'style' => [
                    (object)[
                        'depends' => [
                            (object)['key'=>'showCart','condition'=>'==','value'=>true],
            ...
            'cartPadding' => [
                'type' => 'object',
                'default' => (object)['lg' =>(object)['top' => '7','bottom' => '7','left' => '25','right' => '25', 'unit' =>'px']],
                'style' => [
                    (object)[
                        'depends' => [
                            (object)['key'=>'showCart','condition'=>'==','value'=>true],
                                    ...
                                    $content_data .= '<div class="wopb-product-grid3-content">';
                                        ...
                                        $content_data .= '<div class="wopb-fade-in-block">';
                                            ...
                                            if($attr['showShortDesc']){
                                                $content_data .= '<div class="wopb-short-description">'.($attr['showFullShortDesc'] ? get_the_excerpt() : wopb_function()->excerpt($post_id, $attr['shortDescLimit'])).'</div>';
                                            }
                                            $content_data .= '<div class="wopb-grid3-quick-cart">';
                                                // Add to Cart URL
                                                if($attr['showCart']){
                                                    include WOPB_PATH.'blocks/template/add_to_cart.php';
                                                    $content_data .= $cart_data;
                                                }    
                                                if($attr['quickView'] && wopb_function()->isActive()){
                                                    $content_data .= '<div class="wopb-quick-view" data-postid="'.$post_id.'">'.__( "Quick View", "product-blocks" ).'</div>';
                                                }
                                            $content_data .= '</div>';
                                        $content_data .= '</div>';
                                    $content_data .= '</div>';
