                ...
                $wraper_before .= '<div class="wopb-block-wrapper">';
                    ...
                    if ( $attr['productView'] == 'slide' ) {
                        ...
                        while ( $recent_posts->have_posts() ): $recent_posts->the_post();
                            ...
                            $image_data = $category_data = $title_data = $price_data = $review_data = $cart_data = $title_review_data = $cat_price_data = '';
                                ...
                                $post_loop .= '<div class="wopb-block-content-wrap">';
                                    ...
                                    if( has_post_thumbnail() && $attr['showImage'] ){
                                        $image_data .= '<div class="wopb-block-image wopb-block-image-'.$attr['imgAnimation'].'">';
                                            ...
                                            if( ($attr['quickView'] && wopb_function()->isActive()) ||  $attr['showCart']) {
                                    ...
                                    $post_loop .= $image_data.$cat_price_data.$title_review_data;
